...
const NO_COMESTIBLE_KEYWORDS = [
    ...
    'crema corporal', 'crema manos', 'loción corporal', 'sorbete corporal', 'manteca corporal',
    ...
    'pasta de dientes', 'dentifrico', 'dentífrico', 'cepillo de dientes', 'cepillo dental', 'enjuague bucal', 'hilo dental',
    ...
    'maquillaje', 'brocha maquillaje', 'esponja maquillaje', 'colorete', 'corrector maquillaje', 'base de maquillaje',
    ...
    'ambientador', 'difusor ambientador', 'colgador wc', 'perlas perfume ropa', 'ropa frescor', 'insecticida', 'trampa ratas',
    ...
    'estropajo metálico', 'esponja metálica', 'limpiacoches', 'champú coche', 'oleogel ducha',
