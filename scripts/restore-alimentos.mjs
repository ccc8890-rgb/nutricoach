/**
 * Script para restaurar alimentos perdidos tras DELETE de duplicados.
 * Inserta directamente los alimentos que faltan usando service_role_key.
 * 
 * USO: node scripts/restore-alimentos.mjs
 */
...
// Lista completa de alimentos a restaurar
// Formato: [nombre, categoria, calorias, proteinas, carbohidratos, grasas, fibra, custom]
const alimentos = [
    // ACEITES
...
console.log(`\nTotal alimentos a restaurar: ${alimentos.length}\n`)
...
for (let i = 0; i < alimentos.length; i++) {
    ...
    process.stdout.write(`  [${i + 1}/${alimentos.length}] ${String(nombre).padEnd(40)} `)
